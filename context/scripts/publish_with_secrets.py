...
owner = user['login']
status, created = gh('POST', '/user/repos', {'name': REPO, 'private': False, 'auto_init': False, 'description': 'Triangle AI Growth Raleigh-Durham AI-focused local growth site'})
